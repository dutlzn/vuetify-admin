    ...
    >
      <v-list>
        <v-list-item class="mb-16">
          <v-list-item-content>
            <v-icon class="mb-2" large color="blue">fas fa-comments</v-icon>
          </v-list-item-content>
        </v-list-item>
      </v-list>
      ...
      <v-list style="position: absolute; bottom: 0" class="ml-5" flat>
        <v-list-item router to="/">
          <v-list-item-content>
            <v-icon class="mb-2" color="grey">fas fa-users</v-icon>
          </v-list-item-content>
        </v-list-item>
        <v-list-item router to="/">
          <v-list-item-content>
            <v-icon class="mb-2" color="grey">fas fa-cog</v-icon>
          </v-list-item-content>
        </v-list-item>
        <v-list-item router to="/">
          <v-list-item-avatar class="mb-5">
            <!-- <v-badge boardered bottom color="green" offset-x="10" offset-y="10"> -->
              <v-avatar size="40">
                <v-img
